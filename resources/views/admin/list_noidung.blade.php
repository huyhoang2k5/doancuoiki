...
<div class="container_list_location">
    ...
    <div class="table-container">
                    ...
                    <tr>
                        ...
                        <td style="display: flex; gap: 10px;">
                            <button class="btn-action btn-edit"
                                onclick="window.location='{{ route('add_noidung', ['id' => $item->dia_diem_id]) }}'">Thêm</button>
                            <button class="btn-action btn-edit" style="background-color: yellow"
                                onclick="window.location='{{ route('edit_noidung', ['id' => $item->dia_diem_id]) }}'">Sửa</button>
        ...
        <div class="pagination">
            {{ $noiDungBaiViet->links('vendor.pagination.custom') }}
        </div>
    </div>
</div>
